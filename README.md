...
**https://kazivestengineeringtask.onrender.com/**

Если открываете ссылку **впервые** (или сервис давно простаивал) - подождите немного, буквально **3-5 секунд**. Идёт «пробуждение» инстанса, потом откроется интерфейс чата.

Так бывает из-за **бесплатного тарифа Render**: маленькие мощности, сервис засыпает без трафика. Это нормально для тестового, не баг в коде.
